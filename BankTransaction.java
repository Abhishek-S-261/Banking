...
public class BankTransaction {
    ...
    public BankTransaction(String bankName, String holderName, String accType, long accNumber, double bal) {
        bank_name = bankName;
    ...
    public static void main(String[] args) {
        ...
        BankTransaction transaction1 = new BankTransaction("SBI", "Alice Smith", "Savings", 1234567890L, 15000.50);
